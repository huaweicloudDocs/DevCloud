...
项目采用Scrum模式进行迭代开发，每个迭代周期为**两周**，前3个迭代已经完成**凤凰商城1.0**版本的开发，当前正在进行**迭代4**的规划。
...
## **使用Scrum项目模板进行项目规划，并管理Epic和Feature**<a name="section47834478"></a>
...
-   **项目规划**
    1.  打开凤凰商城项目，单击“工作  \>  需求规划“，项目规划视图以树形结构列出了需求从“Epic\>Feature\>Story\>Task“的逐级关系。
        ...
        <td class="cellrowborder" valign="top" width="75%" headers="mcps1.1.3.1.2 "><p id="p39829225508"><a name="p39829225508"></a><a name="p39829225508"></a>通常是对客户有价值的功能，可以通过使用特性满足客户的需求。比如凤凰商城中的“门店网络查询功能”，特性通常会通过多个迭代持续交付。</p>
        </td>
        </tr>
...
## **使用Scrum项目模板管理backlog并进行迭代开发**<a name="section27857118"></a>
...
-   <a name="li1875913505916"></a>**Backlog管理**
    ...
    1.  单击“工作  \>  工作项“， 进入“工作项“页面。
    2.  在页面左上角单击“Backlog“。
    3.  在列表中单击Story名称“作为用户应该可以查看、查询所有门店网络“，编辑Story。
...
-   **Backlog高级管理**
    ...
    -   **自定义过滤器**
        1.  单击右上角“过滤“，选择“增加过滤字段“，在弹框中勾选“优先级“，单击“确定“。

            ![](figures/04-项目规划-09.png)

              

        2.  **优先级**字段勾选  “高“，单击“保存为过滤器“，输入过滤器名称“高优先级“，单击“确定“保存。
...
-   **迭代规划**
    ...
    接下来，需要对当前迭代（近两周）的工作进行规划，其中最重要的工作“作为用户应该可以查看、查询所有门店网络“需要在本迭代完成并上线。

    1.  在迭代页面，单击“未计划工作项“，找到Story“作为用户应该可以查看、查询所有门店网络“。
...
-   **Story分解**
    ...
    接下来，需要将Story“作为用户应该可以查看、查询所有门店网络“拆分到开发任务级别，并指派给对应的负责人。
...
-   **看板视图使用**
    -   单击列表右上方图标![](figures/icon-卡片模式.png)，切换视图为“卡片模式“。
...
## **使用效率工具监控和跟踪项目状态**<a name="section49387472"></a>
...
-   **项目仪表盘查看以及管理**
    ...
    2.  单击页面右上角“设计布局“，进入编辑模式。

        -   单击任意组件右上角的![](figures/icon-删除.png)，可将此组件移除。
        -   通过鼠标拖拽，可改变组件在仪表盘中的位置。
        -   单击页面右上角“添加卡片“，在页面右侧滑框中可拖拽新组件至仪表盘中。
        -   完成编辑后，单击页面下方“保存“。
        ...
        >以上操作基于新版仪表盘。若您看到的页面与上图不同，请单击页面右上角“切至新版“。  
